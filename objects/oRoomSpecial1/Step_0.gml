...
if(_boolcheck){
if (oPlayer.spriteAttack != playeratt && (RightDIrection == false || global.KillBoss == true))
{
...
else if (oPlayer.spriteAttack == playeratt ) 
{
	ScreenShake(3,30);
	NewTextBox("Go to the Village's house, and get a attack skill",0);
	with(oPlayer)
	{
